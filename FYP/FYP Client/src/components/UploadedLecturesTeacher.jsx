...
const UploadedLecturesTeacher = (props) => {
    ...
    return ( 
        ...
        <main className={classes.content} >
            ...
            <Button  variant="contained" color="primary" disableElevation className={classes.Students} onClick={(e)=>{
              window.location.href="/insideClass/Lectures/"+props.match.params.code;
            }}>
             Upload Lectures
            </Button>
       ...
       console.log("Bahar")
        ...
        // console.log("Tell",Classes),
          Videos.map((classes, index) => (
           <SingleVideo key={index} product={classes}   />
...
export default (UploadedLecturesTeacher);