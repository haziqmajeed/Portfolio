                    ...
                    <div className="header__menu-wrapper">
                        <ul className="header__menu-list">
                            {primaryMenu.map(item => {
                                return (
                                    <li
                                        onMouseEnter={(item?.children?.length !== 0 && !mobileScreen) ? toggleDropdown : () => false}
                                        onMouseLeave={(item?.children?.length !== 0 && !mobileScreen) ? toggleDropdown : () => false}
                                        key={item.id}
                                    ...
                                    >
                                        <div className="header__menu-item-wrapper" ref={el => addToRefs(el, links)}>
                                            <DelayLink
                                                ...
                                                className={"header__menu-link" + ((RelativeLink(item?.url) === '/' + currentPage) ? " active" : "")}
                                            ...
                                            {item?.children?.length !== 0 && <button className={"open open--header" + (dropdownOpened ? " active" : "")} onClick={toggleDropdown}></button>}
